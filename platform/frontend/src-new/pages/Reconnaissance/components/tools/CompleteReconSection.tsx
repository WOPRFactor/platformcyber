    ...
    <div className="mt-4">
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
        ...
        <button
          ...
          className="w-full bg-red-600 hover:bg-red-700 disabled:bg-green-800 disabled:cursor-not-allowed text-white px-4 py-2 rounded-xl flex items-center justify-center gap-2 text-lg font-semibold"
        >
