    ...
    <div className="bg-gray-50 border border-blue-500 rounded-xl p-6">
      ...
      <div className="mb-4">
        ...
        <select
          ...
          className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
        >
      ...
      <button
        ...
        className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
