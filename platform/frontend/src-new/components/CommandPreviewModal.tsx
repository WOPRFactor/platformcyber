      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <div className="bg-gray-950 border border-gray-200 rounded-xl p-4 font-mono text-sm">
          ...
          <div>
            ...
            <div className="bg-gray-950 border border-gray-200 rounded-xl p-4 space-y-3">
                ...
                <div key={key} className="flex items-center gap-3">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="flex-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded-xl text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  ) : (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-950 border border-gray-200 rounded-xl p-4">
              <div className="text-xs text-gray-500 mb-1">Timeout Estimado</div>
              <div className="text-sm font-medium text-gray-600">
                {formatTimeout(previewData.estimated_timeout)}
              </div>
            </div>
            <div className="bg-gray-950 border border-gray-200 rounded-xl p-4">
              <div className="text-xs text-gray-500 mb-1">Archivo de Salida</div>
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-white/50">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-white bg-gray-700 hover:bg-gray-600 rounded-xl transition-colors"
            disabled={isLoading}
          >
            Cancelar
          </button>
