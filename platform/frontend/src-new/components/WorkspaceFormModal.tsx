            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-white border ${errors.name ? 'border-red-500' : 'border-gray-200'} rounded-xl px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500`}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 resize-none"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-white border ${errors.client_name ? 'border-red-500' : 'border-gray-200'} rounded-xl px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-white border ${errors.client_contact ? 'border-red-500' : 'border-gray-200'} rounded-xl px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-white border ${errors.target_domain ? 'border-red-500' : 'border-gray-200'} rounded-xl px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500"
              ...
              <div className="md:col-span-3">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-red-500"
                  disabled={isSubmitting}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-white border ${errors.end_date ? 'border-red-500' : 'border-gray-200'} rounded-xl px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-red-500`}
                  disabled={isSubmitting}
                />
