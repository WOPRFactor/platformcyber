    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-xl border border-red-600">
          ...
          <div className="bg-white p-4 rounded-xl border border-yellow-500">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
          ...
          <div className="bg-white p-4 rounded-xl border border-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-900">Bajas</span>
              </div>
              <span className="text-xl font-bold text-gray-800">{metrics.vulnerabilities.low}</span>
            </div>
            <div className="mt-2 text-sm text-gray-500">
              Riesgo mínimo
            </div>
