...
export const SyftSection: React.FC<SyftSectionProps> = ({ workspaceId }) => {
  ...
  return (
    <div className="mt-4">
      <div className="bg-gray-50 border border-purple-500 rounded-xl p-6">
        <div className="mb-4">
        ...
        <div className="space-y-4 mb-6">
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-gray-200 rounded-xl px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
