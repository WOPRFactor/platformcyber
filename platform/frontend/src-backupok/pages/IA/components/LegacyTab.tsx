    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        {analyzeMutation.isSuccess && (
          <div className="flex items-center space-x-2 text-gray-900 bg-emerald-50 border border-emerald-200 rounded p-3">
            <CheckCircle size={16} />
        ...
        <div className="flex space-x-4">
          <button
            ...
            className="bg-red-600 hover:bg-red-700 text-white rounded-lg px-4 py-2 font-medium flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        <div className="card">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-gray-900">Análisis de Resultados</h3>
          </div>
          ...
          <button
            onClick={handleAnalyze}
            disabled={!query.trim() || isAnyLoading}
            className="bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg px-4 py-2 font-medium w-full flex items-center justify-center space-x-2 transition-colors"
          >
            {analyzeMutation.isPending ? (
        ...
        <div className="card">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-gray-900">Sugerencias de Comando</h3>
          </div>
          <p className="text-sm text-gray-500 mb-4">
        ...
        <div className="card">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-gray-900">Análisis Predictivo</h3>
          </div>
          <p className="text-sm text-gray-500 mb-4">
