      ...
      <div className="flex items-center space-x-4">
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="bg-white border border-gray-200 rounded px-3 py-1 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500"
          >
        ...
        <button
          onClick={onRefresh}
          className="flex items-center space-x-2 px-4 py-2 rounded-md text-gray-700 hover:bg-gray-100 transition-colors border border-gray-200 bg-white"
