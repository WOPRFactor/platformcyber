...
const GlobalSearch: React.FC<GlobalSearchProps> = ({ className }) => {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'module': return 'text-green-600 bg-green-100 dark:bg-green-900 dark:text-green-300'
    ...
    <div ref={searchRef} className={cn("relative", className)}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="block w-80 pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md leading-5 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
        {query && (
          <button
            onClick={() => {
      ...
      {isOpen && (query || results.length > 0) && (
        <div className="absolute z-50 mt-1 w-full bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 max-h-96 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="p-4">
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Búsqueda rápida</p>
