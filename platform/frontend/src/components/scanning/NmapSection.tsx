        ...
        <div className="mt-4">
          <div className="bg-gray-900 border border-green-500 rounded-lg p-6">
            <div className="mb-4">
              ...
              <p className="text-green-600">Escanea los 1000 puertos más comunes usando Nmap -F</p>
            </div>
            <button
        ...
        <div className="mt-4">
          <div className="bg-gray-900 border border-green-500 rounded-lg p-6">
            <div className="mb-4">
              ...
              <p className="text-green-600">Detecta servicios corriendo, versiones y realiza detección OS básica</p>
            </div>
            <button
        ...
        <div className="mt-4">
          <div className="bg-gray-900 border border-green-500 rounded-lg p-6">
            <div className="mb-4">
              ...
              <p className="text-green-600">Ejecuta scripts NSE de vulnerabilidades usando --script vuln</p>
            </div>
            <button
        ...
        <div className="mt-4">
          <div className="bg-gray-900 border border-green-500 rounded-lg p-6">
            <div className="mb-4">
              ...
              <p className="text-green-600">Intenta determinar el sistema operativo usando huellas TCP/IP</p>
            </div>
            <button
        ...
        <div className="mt-4">
          <div className="bg-gray-900 border border-green-500 rounded-lg p-6">
            <div className="mb-4">
              ...
              <p className="text-green-600">Descubre hosts activos en la red usando ping sweeps</p>
            </div>
            <button
        ...
        <div className="mt-4">
          <div className="bg-gray-900 border border-green-500 rounded-lg p-6">
            <div className="mb-4">
              ...
              <p className="text-green-600">Ejecuta todos los tipos de escaneo en secuencia para un análisis completo</p>
            </div>
