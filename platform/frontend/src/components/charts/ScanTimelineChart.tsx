        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-400 text-sm">Fallidos:</span>
            </div>
          ...
          {data.running > 0 && (
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400 text-sm">En ejecución:</span>
              </div>
    ...
    >
      ...
      <div className="flex flex-wrap gap-3 justify-center mt-2 px-6 pb-4">
        <div className="flex items-center space-x-2 px-3 py-1.5 bg-green-500/10 border border-green-500/30 rounded-lg">
          ...
          <span className="text-sm text-green-400 font-bold">{stats.totalCompleted || 0}</span>
        </div>
        ...
        <div className="flex items-center space-x-2 px-3 py-1.5 bg-blue-500/10 border border-blue-500/30 rounded-lg">
