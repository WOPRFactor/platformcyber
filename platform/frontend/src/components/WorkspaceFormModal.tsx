...
const WorkspaceFormModal: React.FC<WorkspaceFormModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-gray-900 border border-green-500/30 rounded-lg shadow-2xl z-[10002]">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-gray-800 border ${errors.name ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500`}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 resize-none"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-gray-800 border ${errors.client_name ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-gray-800 border ${errors.client_contact ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-gray-800 border ${errors.target_domain ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-gray-800 border ${errors.end_date ? 'border-red-500' : 'border-gray-700'} rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-green-500`}
                  disabled={isSubmitting}
                />
          ...
          <div className="flex justify-end gap-4 pt-6 border-t border-gray-700">
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-green-600 hover:bg-green-500 text-white rounded-lg transition-colors font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={isSubmitting}
            >
              {isSubmitting ? (
                <>
