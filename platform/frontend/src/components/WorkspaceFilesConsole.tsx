...
export const WorkspaceFilesConsole: React.FC<WorkspaceFilesConsoleProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-gray-900 border border-green-500 rounded-lg shadow-2xl w-[90vw] h-[85vh] flex flex-col">
        {/* Header */}
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Sidebar - Categorías */}
          <div className="w-64 border-r border-gray-700 bg-gray-800 overflow-y-auto flex-shrink-0">
            <div className="p-4">
              <h3 className="text-sm font-semibold text-gray-400 mb-3">Categorías</h3>
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
                  ...
                  {getBreadcrumbs().map((crumb, index) => (
                    <React.Fragment key={index}>
                      ...
                      {index === getBreadcrumbs().length - 1 ? (
                        <span className="text-green-400 font-medium">{crumb.name}</span>
                      ) : (
                        <button
                          onClick={() => {
            ...
            <div className="p-4 border-b border-gray-700 flex-shrink-0">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-gray-800 border border-gray-700 rounded-md text-white placeholder-gray-500 focus:outline-none focus:border-green-500"
                />
              </div>
            </div>
                    ...
                    if (item.type === 'directory') {
                      ...
                      return (
                        <div
                          ...
                          className="p-3 rounded-md border cursor-pointer transition-colors bg-gray-800 border-gray-700 hover:border-green-500 hover:bg-green-500/10"
                        >
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1 ml-2">
                              <button
                                ...
                                className="p-2 text-gray-400 hover:text-green-400 transition-colors flex-shrink-0"
            ...
            {/* File Content Viewer */}
            {selectedFile && (
              <div className="border-t border-gray-700 h-64 flex flex-col flex-shrink-0">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-gray-700 bg-gray-800 flex items-center justify-between flex-shrink-0">
          <div className="text-sm text-gray-400">
            {filesData ? (
              <>
