          ...
          {tools.map((tool) => (
            <div key={tool.id} className="bg-gray-800 rounded-lg p-4">
              ...
              <button
                ...
                className="w-full bg-teal-600 hover:bg-teal-700 disabled:bg-teal-800 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2"
              >
