    ...
    <div className="mt-4">
      <div className="bg-gray-900 border border-red-500 rounded-lg p-6">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-red-600 to-purple-600 hover:from-red-700 hover:to-purple-700 text-white px-4 py-2 rounded-lg flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {mutation.isPending ? (
        ...
        {mutation.data && (
          <div className="mt-6">
            <div className="bg-gray-800 border border-green-500 rounded-lg p-6 mb-4">
              <h4 className="font-semibold mb-4 text-green-400">Resumen del Análisis Completo</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{mutation.data.summary.successful_phases}</div>
              ...
              <div className="mt-4">
                <p className="text-sm text-green-600">{mutation.data.summary.recommendation}</p>
              </div>
            </div>
          </div>
        )}
