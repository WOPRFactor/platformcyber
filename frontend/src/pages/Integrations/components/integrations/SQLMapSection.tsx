      ...
      {sqlmapMutation.data && (
        <div className="mt-6">
          <div className="bg-gray-800 border border-green-500 rounded-lg p-6 mb-4">
            <h4 className="font-semibold mb-4 text-green-400">Resumen de SQLMap</h4>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className={`text-2xl font-bold ${sqlmapMutation.data?.vulnerable ? 'text-red-600' : 'text-green-600'}`}>
