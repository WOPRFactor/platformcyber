        ...
        <div className="space-y-4">
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-sm text-gray-400">Puertos</label>
                <input
                  type="text"
                  id="masscan-ports"
          ...
          <button
            ...
            className="w-full bg-orange-600 hover:bg-orange-700 disabled:bg-orange-800 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg flex items-center justify-center"
          >
