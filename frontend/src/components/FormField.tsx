...
export const TextInput = forwardRef<HTMLInputElement, TextInputProps>(({
  ...
  const getInputClasses = () => {
    ...
    if (success && isDirty) {
      return `${baseInputClasses} border-green-500 focus:ring-green-500/20`
    }
    return `${baseInputClasses} focus:ring-blue-500/20 focus:border-blue-500`
  }
  ...
  return (
    <div className={`space-y-2 ${className}`}>
      ...
      {/* Mensaje de error */}
      {error && isDirty && (
        <p className={`text-sm ${errorClassName || 'text-red-400'} flex items-center space-x-2`}>
          <AlertCircle size={16} />
          <span>{error}</span>
        </p>
      )}
...
export const TextArea = forwardRef<HTMLTextAreaElement, TextAreaProps>(({
  ...
  const getTextareaClasses = () => {
    ...
    if (success && isDirty) {
      return `${baseTextareaClasses} border-green-500 focus:ring-green-500/20`
    }
    return `${baseTextareaClasses} focus:ring-blue-500/20 focus:border-blue-500`
  }
...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(({
  ...
  const getSelectClasses = () => {
    ...
    if (success && isDirty) {
      return `${baseSelectClasses} border-green-500 focus:ring-green-500/20`
    }
    return `${baseSelectClasses} focus:ring-blue-500/20 focus:border-blue-500`
  }
    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <label className="flex items-center space-x-3 cursor-pointer">
        <input
          ...
          {...props}
        />
        <span className="text-gray-300 text-sm">{checkboxLabel}</span>
      </label>
      ...
      {/* Mensaje de error */}
      {error && isDirty && (
        <p className={`text-sm ${errorClassName || 'text-red-400'} flex items-center space-x-2 ml-7`}>
          <AlertCircle size={16} />
          <span>{error}</span>
        </p>
      )}
