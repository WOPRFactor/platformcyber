  ...
  return (
    <div className="min-h-screen bg-gray-900 text-green-400 font-mono">
      ...
      <header className="w-full h-14 flex items-center justify-between px-4 header">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-md text-green-400 hover:bg-gray-700"
          >
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className={`
          fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 border-r border-green-500 transform transition-transform duration-300 ease-in-out
          md:translate-x-0 md:static md:inset-0
          ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}
        `}>
          <div className="flex flex-col h-full pt-16 md:pt-0">
            {/* Usuario en mobile */}
            <div className="md:hidden p-4 border-b border-green-500">
            ...
            <nav className="flex-1 px-4 py-6 space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-xs font-semibold text-green-500 uppercase tracking-wider px-3">
                  Pentesting Tools
                </h3>
